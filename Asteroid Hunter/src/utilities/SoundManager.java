...
public class SoundManager {
	...
	public final static Clip mainTheme = getClip("MainTheme");
	public final static Clip powerUp = getClip("spacey-power-up");
 ...
 static {
		...
		mainTheme.addLineListener(ev->{themeSong();});
	}
	...
	public static void stopThrust() {
		//thrust.loop(0); //found that stop() makes it stop exactly when you want it to
		thrust.stop();
		thrusting = false;
	}
